# Guía de QA — v0.9.5 (cierre antes de producción)

Reemplaza a la guía de cierre anterior: **el encabezado del Recorder tiene que decir v0.9.5**.
...
### A.1 · Elegir en "¿Cuál estás jugando?" y grabar (PLE-167)

**Qué estaba mal:** cuando el Recorder preguntaba cuál de dos títulos estabas jugando, al
elegir uno y apretar Iniciar grabación la pantalla volvía sola al paso anterior y la grabación
no arrancaba nunca.

1. Abrir **Metro: Last Light** (el de Steam, el que ejecuta `Metro LL.exe`).
2. El panel pregunta *¿Cuál estás jugando?*. Elegir una de las dos opciones.
3. Apretar **Iniciar grabación**.

**Esperado:** arranca la cuenta regresiva, llega a cero y empieza a grabar. La pantalla **no**
vuelve atrás en ningún momento — ni al apretar Iniciar, ni al terminar la cuenta.

4. Dejarlo grabar 2–3 minutos y detener.

**Esperado:** la sesión termina bien y no se cancela sola durante la grabación.

### A.2 · Counter-Strike (PLE-166)

**Qué estaba mal:** el Counter-Strike clásico se identificaba como *Counter-Strike 2*, y al
intentar grabar la pantalla entraba en un ciclo entre "Esperando título" y los dos nombres.

1. Abrir **Counter-Strike 1.6** con OBS apuntado a su ventana.
...
**Esperado:** graba sin volver atrás ni entrar en ciclo.
...
### A.3 · Team Fortress 2 (PLE-163)

1. Abrir TF2 con OBS apuntado a su ventana. Grabar corto y detener.
...
### A.4 · Sylvio y Raft (PLE-165)

**Importante:** las grabaciones de Sylvio de las rondas anteriores no se recuperan. Hay que
**grabar sesiones nuevas**.

1. Abrir Sylvio, esperar la detección, grabar corto y **subir**.
2. Lo mismo con Raft.

**Esperado en los dos:** el título en verde y, debajo, **ORDEN DE DESTINO** con la orden de
prueba seleccionada. La subida termina bien.
...
|---|---|---|
| 1 | Actualizar desde una versión anterior con el Updater | Abre en v0.9.5, con los acentos y los íconos bien |
