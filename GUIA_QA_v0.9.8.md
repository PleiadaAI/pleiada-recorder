...
Reemplaza a las guías anteriores: **el encabezado del Recorder tiene que decir v0.9.8**.
...
|---|---|---|
| 1 | Actualizar desde una versión anterior con el Updater | Abre en v0.9.8, con los acentos y los íconos bien |
